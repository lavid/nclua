...
ASSERT_CHECK_OBJECT (c, 'nclua.canvas')
ASSERT (canvas.dump(c,'test-canvas-dump.png'))
ASSERT (canvas.dump(c,'test-canvas-dump-q1.jpeg', 'jpeg',1))
ASSERT (canvas.dump(c,'test-canvas-dump-q45.jpeg', 'jpeg',45))
ASSERT (canvas.dump(c,'test-canvas-dump-q100.jpeg', 'jpeg',100))
ASSERT (c:dump('test-canvas-dump.jpeg','jpeg'))
--ASSERT (c:dump('test-canvas-dump.gif','gif'))
